...
import { MSG_REGISTER_SUCCESS } from '../../constants/messages';
...
const SignUpLink = () => (
  <p className="mt-3 sign-up">
    ...
    <Link className="text-fundra-secondary-black ml-1" to={ROUTES.SIGN_UP}>
      Register
    </Link>
  </p>
);
...
const SignInLink = () => (
  <p className="mt-3 sign-up">
    ...
    <Link className="text-fundra-secondary-black ml-1" to={ROUTES.SIGN_IN}>
      Sign In
    </Link>
  </p>
);
