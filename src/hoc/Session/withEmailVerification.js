...
const withEmailVerification = (Component) => {
              ...
              >
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Check you E-Mails (Spam folder included) for a confirmation E-Mail or send another confirmation
                      E-Mail.
                    </p>
                  </div>
                </div>
  ...
  WithEmailVerification.contextType = FirebaseContext;

  WithEmailVerification.propTypes = { authUser: PropTypes.instanceOf(Object) };
  WithEmailVerification.defaultProps = { authUser: null };
